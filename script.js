...
const studentGraduationElement = document.querySelector("#student-graduation-year")
...
const semesterDropdownFallElement = document.querySelector("#fall-semester")
const semesterDropdownWinterElement = document.querySelector("#winter-term")
const semesterDropdownSpringElement = document.querySelector("#spring-semester")
const semesterReportCardElement = document.querySelector(".report-card-table")
...
function updateStudentGraduationYear(graduationYear) {
  studentGraduationElement.innerHTML = graduationYear
}
...
window.onload = function () {
  ...
  addEventListeners(
    dropdownEl,
    semesterDropdownButtonElement,
    semesterReportCardElement,
    semesterDropdownFallElement,
    semesterDropdownSpringElement,
    semesterDropdownWinterElement
  )
  populateStudentInfo(studentInformation)
  updateReportCard(semesterReportCardElement, semester)
}
